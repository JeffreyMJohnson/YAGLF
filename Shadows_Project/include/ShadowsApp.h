...
public:
	...
	const char* VERTEX_SHADER_PATH = "../Shadows_Project/source/shaders/Lighting_Vert_shader.glsl";
	const char* FRAGMENT_SHADER_PATH = "../Shadows_Project/source/shaders/Lighting_Frag_Shader.glsl";
